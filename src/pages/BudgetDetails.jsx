...
function BudgetDetails() {
  ...
  const { budgets, transactions, setBudgets, defaultCurrency, currencySymbol, currentMonth, getMonthLabel } = useFinance();
