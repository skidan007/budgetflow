...
function BudgetDetails() {
  ...
  const dailyPlan = calculateDailyBudgetStatus({ budgetAmount: safeBudget, spentAmount: spent, spentToday, month: budgetMonth });
